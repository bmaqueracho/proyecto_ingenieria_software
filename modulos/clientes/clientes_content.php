...
<style>
    ...
    .table-wrapper thead th {
        background-color: #f9fafb; /* Un gris muy claro para la cabecera */
    ...
    .table-wrapper tbody tr:hover {
        background-color: #eff6ff; /* Un azul muy claro al pasar el mouse */
    }
      ...
      <?php else: ?>
        ...
        <div class="form-section">
          ...
          <form action="../clientes/clientes_procesar.php" method="POST">
            ...
            <div class="mb-3"><label class="form-label">Teléfono</label><input type="text" name="telefono" class="form-control" placeholder="Opcional"></div>
            <div class="mb-3"><label class="form-label">Observación</label><textarea name="observacion" class="form-control" rows="2" placeholder="Opcional"></textarea></div>
            <button type="submit" class="btn btn-success w-100 mt-2"><span class="btn-icon-text"><i class="fas fa-plus-circle"></i>Registrar Cliente</span></button>
          </form>
        </div>
      <?php endif; ?>
    </div>
       ...
       <div class="card action-card">
            ...
            <div class="table-wrapper">
                <table class="table table-hover">
                    <thead>
                        <tr><th>DNI</th><th>Nombres</th><th>Apellidos</th><th>Teléfono</th><th>observacion</th></tr>
                    </thead>
                    <tbody>
